// 1. 주어진 배열을 가지고 각 질문에 맞는 코드를 작성해보자
...
// "Tiger"부터 그 이후의 값을 제거하시오 (Tiger 포함임)
    ...
    // console.log(animals.length-animals.indexOf("Tiger"))
    animals.splice(animals.indexOf("Tiger"), animals.length-animals.indexOf("Tiger"))
    console.log(animals)
